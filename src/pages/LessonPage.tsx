            ...
            <AnimatePresence>
              {!isStarted && (
                <motion.div
                  ...
                  className="bg-primary-500 text-white rounded-xl p-3 sm:p-4 lg:p-6 mb-4 sm:mb-6 text-center"
                >
                  <div className="text-base sm:text-lg lg:text-xl font-display font-bold mb-1 sm:mb-2">
                    🎯 Ready to Type!
                  </div>
